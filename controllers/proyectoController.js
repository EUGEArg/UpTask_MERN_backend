...
const obtenerProyectos = async(req, res) => {
    const proyectos = await Proyecto.find({ //.Trae todos los proyectos almacenados en la BD.    
...
const obtenerProyecto = async (req, res) => {
    ...
    const proyecto = await Proyecto
        ...
        }) //La ref es por el campo que tenemos en el modelo Proyecto
...
const editarProyecto = async(req, res) => {
    ...
    const proyecto = await Proyecto.findById(id.trim()); //!ver trim
